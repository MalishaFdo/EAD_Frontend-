        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-0">
            ...
            <p class="mt-6 text-lg leading-8 text-gray-300">
              Welcome to the admin dashboard, your control center for managing
              all aspects of the railway experience, from scheduling to revenue
              tracking, ensuring you stay in control and on track.
            </p>
          </div>
