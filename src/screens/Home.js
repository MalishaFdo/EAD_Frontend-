...
export default function Home() {
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-0">
      ...
      <p class="mt-6 text-lg leading-8 text-gray-300">Welcome to the admin dashboard, your control center for managing all aspects of the railway experience, from scheduling to revenue tracking, ensuring you stay in control and on track.</p>
    </div>
    <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
      <div class="grid grid-cols-1 gap-x-8 gap-y-6 text-base font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-10">
        <a href="/travelInfo">Traveler Information <span aria-hidden="true">&rarr;</span></a>
        <a href="/details">Reservation Details <span aria-hidden="true">&rarr;</span></a>
        <a href="/schedule">Train Schedules  <span aria-hidden="true">&rarr;</span></a>
      </div>
      <dl class="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
        <div class="flex flex-col-reverse">
          <dt class="text-base leading-7 text-gray-300">Company Branches</dt>
          <dd class="text-2xl font-bold leading-9 tracking-tight text-white">12</dd>
        </div>
        <div class="flex flex-col-reverse">
          <dt class="text-base leading-7 text-gray-300">Full-time Support</dt>
